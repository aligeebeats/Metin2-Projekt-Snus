...
class AffectShower(ui.Window):
	...
	AFFECT_DATA_DICT =	{
			...
			MALL_DESC_IDX_START+player.POINT_MALL_DEFBONUS : (localeInfo.TOOLTIP_MALL_DEFBONUS_STATIC, "d:/ymir work/ui/skill/common/affect/att_bonus.sub",),
	...
	def __AppendAffect(self, affect):
		...
		image.SetToolTipText(name, 0, 40) ## hier ansetzen fliege
		image.SetScale(0.7, 0.7)
		image.Show()
		self.affectImageDict[affect] = image
	...
	def OnUpdate(self):		
		try:
		#	if app.GetGlobalTime() - self.lastUpdateTime > 500: ##Fliege
