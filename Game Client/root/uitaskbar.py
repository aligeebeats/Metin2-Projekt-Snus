...
class TaskBar(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		if app.ENABLE_HUNTING_SYSTEM:
			toggleButtonDict[TaskBar.BUTTON_HUNTING]=self.GetChild("HuntingButton")
