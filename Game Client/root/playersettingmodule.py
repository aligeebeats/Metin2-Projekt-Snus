...
def DefineSkillIndexDict():
	...
	SKILL_INDEX_DICT = {
		JOB_WARRIOR : { 
			...
			"SUPPORT" : (122, 123, 121, 124, 129, 131, 130, 0, 0, 0,),
		},
		JOB_ASSASSIN : { 
...
def __InitData():
	...
	if app.ENABLE_LOCAL_FILE:
		chrmgr.LoadLocalRaceData("root/warrior_m.msm")
	else:
	...
	if app.ENABLE_LOCAL_FILE:
		chrmgr.LoadLocalRaceData("root/warrior_w.msm")
	else:
	...
	if app.ENABLE_LOCAL_FILE:
		chrmgr.LoadLocalRaceData("root/assassin_w.msm")
	else:
	...
	if app.ENABLE_LOCAL_FILE:
		chrmgr.LoadLocalRaceData("root/assassin_m.msm")
	else:
	...
	if app.ENABLE_LOCAL_FILE:
		chrmgr.LoadLocalRaceData("root/sura_m.msm")
	else:
	...
	if app.ENABLE_LOCAL_FILE:
		chrmgr.LoadLocalRaceData("root/sura_w.msm")
	else:
	...
	if app.ENABLE_LOCAL_FILE:
		chrmgr.LoadLocalRaceData("root/shaman_w.msm")
	else:
	...
	if app.ENABLE_LOCAL_FILE:
		chrmgr.LoadLocalRaceData("root/shaman_m.msm")
	else:
	...
	if app.ENABLE_WOLFMAN:
		...
		if app.ENABLE_LOCAL_FILE:
			chrmgr.LoadLocalRaceData("root/wolfman_m.msm")
		else:
...
def __LoadGameEffect():
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+0, "Bip01", "locale/de/effect/gm.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_BOSS, "", "locale/de/effect/boss.mse")
	...
	if app.ENABLE_WOLFMAN:
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+39, "Bip01", "d:/ymir work/effect/hit/blow_poison/bleeding_loop.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+40, "Bip01", "d:/ymir work/effect/hit/blow_flame/flame_loop_w.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+41, "", "d:/ymir work/pc3/common/effect/gyeokgongjang_loop_w.mse")
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+21, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-5_jin.mse")
	if app.ENABLE_WOLFMAN:
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+28, "Bip01", "D:/ymir work/pc/common/effect/armor/armor_7th_01.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+29, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_7th.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+30, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_7th_s.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+31, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_7th_s.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+32, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_7th_f.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+33, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_7th_s.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+34, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_7th_b.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+35, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_7th_f.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+36, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_7th_f.mse")
...
if app.ENABLE_WOLFMAN:
	...
	##	chrmgr.SetMotionRandomWeight(chr.MOTION_MODE_GENERAL, chr.MOTION_WAIT, 0, 100)
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, chr.MOTION_WAIT, "wait.msa", 70)
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, chr.MOTION_WAIT, "wait1.msa", 15)
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_GENERAL, chr.MOTION_WAIT, "wait2.msa", 15)
		...
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_CLAW, chr.MOTION_WAIT,				"wait1.msa", 15)
		chrmgr.RegisterCacheMotionData(chr.MOTION_MODE_CLAW, chr.MOTION_WAIT,				"wait2.msa", 15)
...
def __LoadGameNPC():
	try:
		if app.ENABLE_LOCAL_FILE:
			lines = pack_open("root/npclist.txt", "r").readlines()
		else:
