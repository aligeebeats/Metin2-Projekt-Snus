...
#  define LZO_MM_FLAT           1
	...
	#endif
#else
	#define __lzo_c99_extern_inline
#endif
...
LZO_COMPILE_TIME_ASSERT_HEADER(LZO_SIZEOF_VOID_P == sizeof(void*))
	...
	#define LZO_ASM_SYNTAX_GNUC 1
		...
		#define __LZO_ASM_CLOBBER_LIST_CC
		#define __LZO_ASM_CLOBBER_LIST_CC_MEMORY
		#define __LZO_ASM_CLOBBER_LIST_EMPTY
...
#define LZO_INFO_STRING \
	...
	" " __LZO_INFOSTR_OSNAME __LZO_INFOSTR_LIBC " " LZO_INFO_CC __LZO_INFOSTR_CCVER
		...
		#  error "missing defines for sizes"
	#endif
	#define LZO_decltype_CHAR             1u
	#define LZO_decltype_SHORT            2u
	#define LZO_decltype_INT              3u
	#define LZO_decltype_LONG             4u
	#define LZO_decltype_LONG_LONG        5u
	#define LZO_decltype___INT8           17u
	#define LZO_decltype___INT16          18u
	#define LZO_decltype___INT32          19u
	#define LZO_decltype___INT64          20u
	#define LZO_decltype___INT128         21u
	#define LZO_decltype___INT256         22u
	#define LZO_decltype___MODE_QI        33u
	#define LZO_decltype___MODE_HI        34u
	#define LZO_decltype___MODE_SI        35u
	#define LZO_decltype___MODE_DI        36u
	#define LZO_decltype___MODE_TI        37u
	#define LZO_decltype_CHAR_P           129u
		...
		LZO_COMPILE_TIME_ASSERT_HEADER(sizeof(lzo_int16e_t) == LZO_SIZEOF_LZO_INT16E_T)
			...
			#define LZO_decltype_LZO_INT32E_T   LZO_decltype___INT32
		#else
		#endif
	#endif
	#if defined(lzo_int32e_t)
		...
		LZO_COMPILE_TIME_ASSERT_HEADER(sizeof(lzo_int32e_t) == LZO_SIZEOF_LZO_INT32E_T)
			...
			#define LZO_decltype_LZO_INT64E_T   LZO_decltype___INT64
			#if (LZO_CC_BORLANDC)
		...
		LZO_COMPILE_TIME_ASSERT_HEADER(sizeof(lzo_int64e_t) == LZO_SIZEOF_LZO_INT64E_T)
			...
			#define LZO_decltype_LZO_INT32L_T   LZO_decltype_LZO_INT32E_T
			...
			#define LZO_decltype_LZO_INT32L_T   LZO_SIZEOF_INT
			...
			#define LZO_decltype_LZO_INT32L_T   LZO_SIZEOF_LONG
		#else
			#  error "lzo_int32l_t"
		#endif
	#endif
		...
		LZO_COMPILE_TIME_ASSERT_HEADER(sizeof(lzo_int32l_t) == LZO_SIZEOF_LZO_INT32L_T)
			...
			#define LZO_decltype_LZO_INT64L_T   LZO_decltype_LZO_INT64E_T
		#else
		#endif
	#endif
	#if defined(lzo_int64l_t)
		...
		LZO_COMPILE_TIME_ASSERT_HEADER(sizeof(lzo_int32f_t) == LZO_SIZEOF_LZO_INT32F_T)
			...
			#define LZO_decltype_LZO_INT64F_T   LZO_decltype_LZO_INT64L_T
		#else
		#endif
	#endif
	#if defined(lzo_int64f_t)
		...
		LZO_COMPILE_TIME_ASSERT_HEADER(sizeof(lzo_int64f_t) == LZO_SIZEOF_LZO_INT64F_T)
			...
			#define LZO_decltype_LZO_INTPTR_T   LZO_decltype_CHAR_P
			...
			#define LZO_decltype_LZO_INTPTR_T   LZO_decltype_INT
			...
			#define LZO_decltype_LZO_INTPTR_T   LZO_decltype_SHORT
			...
			#define LZO_decltype_LZO_INTPTR_T   LZO_decltype_LONG
			...
			#define LZO_decltype_LZO_INTPTR_T   LZO_decltype_LZO_INT64L_T
		#else
			#  error "lzo_intptr_t"
		#endif
	#endif
		...
		LZO_COMPILE_TIME_ASSERT_HEADER(sizeof(lzo_intptr_t) == sizeof(lzo_uintptr_t))
				...
				#define LZO_decltype_LZO_WORD_T     LZO_decltype_LZO_INTPTR_T
				...
				#define LZO_decltype_LZO_WORD_T     LZO_decltype_LONG
				...
				#define LZO_decltype_LZO_WORD_T     LZO_decltype_INT
				...
				#define LZO_decltype_LZO_WORD_T     LZO_decltype_SHORT
			#elif (LZO_WORDSIZE == 1)
				#define lzo_word_t                unsigned char
				#define lzo_sword_t               signed char
				#define LZO_SIZEOF_LZO_WORD_T     1
				#define LZO_decltype_LZO_WORD_T     LZO_decltype_CHAR
				...
				#define LZO_decltype_LZO_WORD_T     LZO_SIZEOF_LZO_INT64L_T
					...
					#define LZO_decltype_LZO_WORD_T     LZO_decltype___MODE_V16QI
				#endif
			#else
				#  error "lzo_word_t"
			#endif
		...
		#define LZO_decltype_LZO_INT8_T       LZO_decltype_CHAR
		...
		#define LZO_decltype_LZO_INT16_T      LZO_decltype_LZO_INT16E_T
		...
		#define LZO_decltype_LZO_INT32_T      LZO_decltype_LZO_INT32E_T
		...
		#define LZO_decltype_LZO_INT64_T      LZO_decltype_LZO_INT64E_T
		...
		#define LZO_decltype_LZO_INT_LEAST32_T LZO_decltype_LZO_INT32L_T
		...
		#define LZO_decltype_LZO_INT_LEAST64_T LZO_decltype_LZO_INT64L_T
		...
		#define LZO_decltype_LZO_INT_FAST32_T LZO_decltype_LZO_INT32F_T
		...
		#define LZO_decltype_LZO_INT_FAST64_T LZO_decltype_LZO_INT64F_T
