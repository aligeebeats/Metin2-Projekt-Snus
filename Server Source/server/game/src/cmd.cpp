...
struct command_info cmd_info[] =
{
	...
	{ "start_set",				do_start_set,				0,				POS_DEAD,		GM_PLAYER		},
	{ "item_start_set",			do_item_start_set,			0,				POS_DEAD,		GM_PLAYER		},
	{ "attr_start_set",			do_attr_start_set,			0,				POS_DEAD,		GM_PLAYER		},
	{ "attr_start_set1",		do_attr_start_set1,			0,				POS_DEAD,		GM_PLAYER		},
#ifdef ENABLE_WOLFMAN
...
void interpret_command(LPCHARACTER ch, const char * argument, size_t len)
{
	...
	if (ch->GetGMLevel() >= GM_LOW_WIZARD)
	{
		if (cmd_info[icmd].gm_level >= GM_LOW_WIZARD)
		{
			...
			LogManager::instance().GMCommandLog(ch->GetName(), buf);
		}
	}
}
