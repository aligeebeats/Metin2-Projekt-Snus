...
class CGuild
{
	public:
		...
		void		RequestDepositMoney(LPCHARACTER ch, long long lldGold);
		void		RequestWithdrawMoney(LPCHARACTER ch, long long lldGold);
		void		RecvMoneyChange(long long lldGold);
		void		RecvWithdrawMoneyGive(long long lldChangeGold);
		long long	GetGuildMoney() const	{ return m_data.gold; }
