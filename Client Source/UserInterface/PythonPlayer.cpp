...
int CPythonPlayer::GetSpecialInventoryTypeByGlobalSlot(int iSlot)
{
	...
	//else if (iSlot >= c_Special_Inventory_Chest_Slot_Start && iSlot < c_Special_Inventory_Chest_Slot_End)
	//{
	//	return INVENTORY_TYPE_CHEST;
	//}
...
void CPythonPlayer::SetAcceItemData(DWORD dwSlotIndex, TItemPos srcPos, const TItemData& rItemInstance)
{
...
void CPythonPlayer::DelAcceItemData(DWORD dwSlotIndex, TItemPos srcPos)
{
	if (dwSlotIndex >= m_ItemAcceInstanceVector.size())
	{
