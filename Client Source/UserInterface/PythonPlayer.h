...
class CPythonPlayer : public CSingleton<CPythonPlayer>, public IAbstractPlayer
{
	public:
		...
		{
			SAutoPotionInfo() : bActivated(false), totalAmount(0), currentAmount(0), inventorySlotIndex(0) {}
	...
	public:
		...
		void	SetAcceItemData(DWORD dwSlotIndex, TItemPos srcPos, const TItemData& rItemInstance);
		void	DelAcceItemData(DWORD dwSlotIndex, TItemPos srcPos = NPOS);
