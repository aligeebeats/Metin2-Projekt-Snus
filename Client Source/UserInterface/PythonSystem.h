...
class CPythonSystem : public CSingleton<CPythonSystem>
{
	public:
		...
		typedef struct SConfig
		{
			...
			bool			bShowDamage;
			bool			bShowSalesText;
			bool			bShowMonsterEffects;
			bool			bShowSkillEffects;
			bool			bShowBuffEffects;
			bool			bShowYang;
			bool			bFogMode;
#ifdef ENABLE_FOV
			int				iFovValue;
	...
	public:
		...
		void							SetShowMonsterEffects(int iFlag);
		bool							IsShowMonsterEffects();
