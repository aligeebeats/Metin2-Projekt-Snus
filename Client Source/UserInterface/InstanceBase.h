...
{	
...
#endif
			EFFECT_BODYARMOR_SPECIAL4 = 28,
			EFFECT_SWORD_REFINED7TH_SWORD,
			EFFECT_SWORD_REFINED7TH_SMALL,
			EFFECT_SWORD_REFINED7TH_SMALL_LEFT,
			EFFECT_SWORD_REFINED7TH_FAN,
			EFFECT_SWORD_REFINED7TH_SMALLSWORD,
			EFFECT_SWORD_REFINED7TH_BOW,
			EFFECT_SWORD_REFINED7TH_CLAW,
			EFFECT_SWORD_REFINED7TH_CLAW_LEFT,
			EFFECT_REFINED_NUM,
		};
	...
	public:
		...
		void					SetAcceRefineEffect(BYTE acceDrainRate);
		void					RefreshAcceRefineEffect();
	...
	public:
		void SetShowMonsterEffects(bool show);
