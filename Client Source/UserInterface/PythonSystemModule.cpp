...
PyObject * systemSetShowMonsterEffectsFlag(PyObject * poSelf, PyObject * poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowMonsterEffects(iFlag);

	return Py_BuildNone();
}

PyObject* systemSetShowSkillEffectsFlag(PyObject* poSelf, PyObject* poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowSkillEffects(iFlag);

	return Py_BuildNone();
}

PyObject* systemSetShowBuffEffectsFlag(PyObject* poSelf, PyObject* poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowBuffEffects(iFlag);

	return Py_BuildNone();
}

PyObject* systemSetShowYang(PyObject* poSelf, PyObject* poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetShowYang(iFlag);

	return Py_BuildNone();
}

PyObject * systemIsShowMonsterEffects(PyObject * poSelf, PyObject * poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowMonsterEffects());
}

PyObject* systemIsShowSkillEffects(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowSkillEffects());
}

PyObject* systemIsShowBuffEffects(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowBuffEffects());
}

PyObject* systemIsShowYang(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsShowYang());
}
...
void initsystem()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "SetShowMonsterEffectsFlag",	systemSetShowMonsterEffectsFlag,	METH_VARARGS },
		{ "SetShowSkillEffectsFlag",	systemSetShowSkillEffectsFlag,		METH_VARARGS },
		{ "SetShowBuffEffectsFlag",		systemSetShowBuffEffectsFlag,		METH_VARARGS },
		{ "SetShowYang",				systemSetShowYang,					METH_VARARGS },
		{ "IsShowMonsterEffects",		systemIsShowMonsterEffects,			METH_VARARGS },
		{ "IsShowSkillEffects",			systemIsShowSkillEffects,			METH_VARARGS },
		{ "IsShowBuffEffects",			systemIsShowBuffEffects,			METH_VARARGS },
		{ "IsShowYang",					systemIsShowYang,					METH_VARARGS },
